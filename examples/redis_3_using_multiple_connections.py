...
""" Получение записей """
item_from_redis_1: list[ExampleItem] = ExampleItem.using(db_instance=redis_1).get(subsystem_id=3, tag_id=15)
print(f"{item_from_redis_1=}")
item_from_redis_2: list[ExampleItem] = ExampleItem.using(db_instance=redis_2).get(subsystem_id=3, tag_id=15)
